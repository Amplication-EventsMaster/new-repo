...
@InputType()
class AppointmentCreateNestedManyWithoutCalendarsInput {
...
export { AppointmentCreateNestedManyWithoutCalendarsInput as AppointmentCreateNestedManyWithoutCalendarsInput };
